...
import { ArrowRight, Package, Shield, Globe, Clock, Search, Plane } from 'lucide-react';
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in">
              ...
              <Button 
                ...
                size="lg" 
                variant="outline" 
                className="bg-white text-primary hover:bg-white/90 hover:text-primary border-transparent text-lg px-8 shadow-sm transition-all"
              >
      ...
      <section className="py-20 bg-gradient-primary text-primary-foreground">
        <div className="container text-center">
          ...
          <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto">
            {user && isCarrier
              ? 'Gérez vos offres de transport et rentabilisez vos kilos depuis votre tableau de bord.'
              : user
              ? 'Rejoignez notre réseau de transporteurs et proposez vos kilos disponibles à des expéditeurs.'
              : "Rejoignez des milliers d'utilisateurs qui font confiance à Kilotravel pour leurs envois de colis."}
          </p>
          <Button
            asChild
            size="lg"
