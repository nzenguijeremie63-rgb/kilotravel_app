          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-center">
              <div className="mb-2 flex justify-center">
                <CountryFlag country={offer.departure_country} flag={offer.departure_country_flag} size="lg" />
              </div>
            ...
            <div className="text-center">
              <div className="mb-2 flex justify-center">
                <CountryFlag country={offer.arrival_country} flag={offer.arrival_country_flag} size="lg" />
              </div>
